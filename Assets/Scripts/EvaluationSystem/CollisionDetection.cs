...
public class CollisionDetection : MonoBehaviour
{
    ...
    {   /* if object entered the colliders on the body and the forks of the forklift
        ...
        if (other.tag!="step" && other.tag!="pallet" && other.tag!="forklift" && other.tag != "Finish" && other.tag != "Begin" && other.tag != "cargo")
        {
           

           // Debug.Log("this is an alert " + other.tag );
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        //FindObjectOfType<RedLight>().Light.intensity();   }
}
